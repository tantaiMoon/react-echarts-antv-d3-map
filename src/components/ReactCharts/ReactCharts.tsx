...
const mapOpt = {
  ...
  tooltip: {
    // formatter 为函数时，参数params 表示的是data里的每一项数据对象（series里的）
    // formatter: '{a}{b}{c}' // a  为 系列名（series中的name） b 为城市  c 为 值
  },
  grid: {
    top: '80px',
    left: '1px',
  ...
  visualMap: {
    ...
    seriesIndex: [1],
    inRange: {
      color: ['#004981', '#302b63', '#004981'] // 黑紫黑
    }
  },
  series: [
    {
...
const ReactCharts: FunctionComponent<Props> = (props) => {
  const { type } = props
